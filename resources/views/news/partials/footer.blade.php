	...
	<ul class="no-bullet clearfix">
		<li class="widget four column">
        	...
        	<div class="textwidget">
        		...
        		<p>GV Hướng Dẫn Phạm Quốc Trung.</p>
       		</div>
		</li>
		<li class="widget four column">
		...
		<li class="widget four column">
        	...
        	<div class="twitter-widget">
        		<ul class="arrow-list">
        			<li><a href="#">Nguyễn Quốc Khải</a></li>
        			<li><a href="#">Nguyễn Quốc Khánh</a></li>	
        			<li><a href="#">GVHD: Phạm Quốc Trung</a></li>
        		</ul>
        	</div>
		</li>
	</ul>
